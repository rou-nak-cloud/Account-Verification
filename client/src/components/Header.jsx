...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <h1 className='text-xl sm:text-3xl font-medium mb-2'>Hey <span className='text-indigo-800/90 font-mono text-shadow-sm  text-shadow-indigo-300/90'>{userData ? userData.name : 'Developer'}!</span></h1>
